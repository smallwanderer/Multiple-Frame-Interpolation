...
import gin.tf
from models.my_net import interpolator as film_net_interpolator, options as film_net_options
...
def _create_film_net_model(num_frames: int = 4) -> tf.keras.Model:
    ...
    return film_net_interpolator.create_model(x0, x1, options)
